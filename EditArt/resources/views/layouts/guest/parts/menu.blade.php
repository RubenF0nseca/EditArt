...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top py-3" >
    <div class="container"><a class="navbar-brand" href="#"><img src="/public/icons/favicon-32x32.png" alt="EditArt" width="60" /><span class="text-1000 fs-1 ms-2 fw-medium">Edit<span class="fw-bold">Art</span></span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex py-3 py-lg-0">
                ...
                <button class="btn btn-enter rounded-pill order-0" type="submit">Entrar</button>
            </form>
        </div>
    </div>
</nav>
