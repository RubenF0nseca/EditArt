        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            ...
            <form class="d-flex py-3 py-lg-0">
                <ul class="navbar-nav mx-auto pt-2 pt-lg-0">
                    <li class="nav-item"><x-button.link link="{{ route('login') }}" color="light-new rounded-pill" type="submit">{{ __('menu.login') }}</x-button.link></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('cart') }}"><i class="fa-solid fa-cart-shopping" id="cart-icon"></i></a></li>
                    <!-- Tradução PT/EN -->
                    <li class="nav-item">
                        @if(app()->getLocale() === 'pt')
