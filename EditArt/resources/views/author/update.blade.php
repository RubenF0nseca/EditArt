...
@section('title', __('author.edit_author_title'))
            ...
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    <div class="card-header">
                        <h4>{{ __('author.edit_author_heading') }}</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.authors.update', $author->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            @method('PUT')
                            <div class="mb-3">
                                <label for="name" class="form-label required">{{ __('author.name') }}</label>
                            ...
                            <div class="mb-3">
                                <label for="biography" class="form-label required">{{ __('author.biography') }}</label>
                            ...
                            <div class="mb-3">
                                <label for="birthdate" class="form-label required">{{ __('author.birthdate') }}</label>
                            ...
                            <div class="mb-3">
                                <label for="profilePicture" class="form-label required">{{ __('author.profile_picture') }}</label>
                                <input type="file"
                                       id="profilePicture"
                                       name="profilePicture"
                            ...
                            <div class="text-end">
                                <x-button.submit color="solid">{{ __('author.save_button') }}</x-button.submit>
                                <x-button.link link="{{ route('admin.authors.show', $author->id) }}" color="dark-solid">{{ __('author.cancel_button') }}</x-button.link>
                            </div>
                        </form>
                    </div>
                </div>
