                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" id="publicationDate" name="publicationDate" class="form-control @error('publicationDate') is-invalid @enderror" value="{{old('publicationDate')}}" >
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="editionNumber" name="editionNumber" class="form-control @error('editionNumber') is-invalid @enderror" value="{{old('editionNumber')}}" >
                                @error('editionNumber')
                                <div class="invalid-feedback" >{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="numberOfPages" name="numberOfPages" class="form-control @error('numberOfPages') is-invalid @enderror" value="{{old('numberOfPages')}}" >
                                @error('numberOfPages')
                                <div class="invalid-feedback" >{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="language" name="language" class="form-control @error('language') is-invalid @enderror" value="{{old('language')}}" >
                                @error('language')
                                <div class="invalid-feedback" >{{$message}}</div>
                                @enderror
                            </div>
